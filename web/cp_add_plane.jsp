                                                    ...
                                                    <div class="user_name_common" style="width:400px;">
                                                        <div class="user_name_common" style="width:400px;">
                                                            <div class="text_feeld">
                                                                <h2><input type="text" name="model" id="title" class="textbox" maxlength="100" value=""></h2>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="user_name_common" style="width:400px;">
                                                        <div class="user_name_common" style="width:400px;">
                                                            <div class="text_feeld">
                                                                <h2><input type="text" name="capacity" id="title" class="textbox" maxlength="100" value=""></h2>
                                                            </div>
                                                        </div>
                                                        <div id="errorTitle" style="width:500px;padding-top:4px"><br>
                                                        </div>    
