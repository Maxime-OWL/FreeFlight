        ...
        <div class="banner_left">
            ...
            <div class="dash_lsd user_panel_list">
                <ul>
                    ...
                    <li class="act_class" id="dashboard_active"><a href="cp_1.jsp?current_page=dashboard" title="Manage User">Dashboard</a></li>
                        <% } else { %>
                    <li class="" id="edit_profile_active"><a href="cp_1.jsp?current_page=dashboard" title="Manage User">Dashboard</a></li>
                        <% }
                            if (rank >= 0) {
                                if ((current_page != null) && current_page.equalsIgnoreCase("my_account")) { %>
                    <li class="act_class" id="dashboard_active"><a href="cp_my_account_1.jsp?current_page=my_account" title="My account">My account</a></li>
                        <%  } else { %>
                    <li class="" id="edit_profile_active"><a href="cp_my_account_1.jsp?current_page=my_account" title="My account">My account</a></li>
                        <%  }
                            }
                            if (rank == 1) {
                        %>
